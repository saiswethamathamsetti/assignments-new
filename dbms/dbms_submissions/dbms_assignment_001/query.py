...
Q5="INSERT INTO Post (user_id,post_id,post_content) values(1,NULL,'my first post')"
Q6="SELECT * FROM User"
...
Q9="INSERT INTO Post (user_id,post_id,post_content) values(2,NULL,'My Second Post')"
